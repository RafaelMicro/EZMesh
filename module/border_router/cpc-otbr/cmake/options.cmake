...
option(CPC_OTBR_BORDER_ROUTING "enable border routing features" 1)
option(CPC_OTBR_BACKBONE_ROUTER "enable backbone routing features" 1)
option(CPC_OTBR_REFERENCE_DEVICE "enable openthread reference device feature-set" 0)
option(CPC_OTBR_RELEASE "remove dependency on testing utilities" 1) # Unused - no runtime dependencies
option(CPC_OTBR_NAT64 "include nat64 service" 0)
option(CPC_OTBR_DNS64 "include dns64 service" 0)
# option(CPC_OTBR_WEB_GUI "include web gui service" 0)
# option(CPC_OTBR_REST_API "include rest api support" 0)
option(CPC_OTBR_DHCPV6_PD "include dhcp service" 0)
option(CPC_OTBR_NETWORK_MANAGER "include network manager service" 0)
...
set(OTBR_RADIO_URL "spinel+cpc://cpcd_0?iid=2" CACHE STRING "URL")
...
set(CPC_OTBR_RECS "rsyslog, libavahi-client3, avahi-daemon, libjsoncpp-dev")
...
if(CPC_OTBR_NAT64)
    ...
    string(APPEND CPC_OTBR_RECS ", ${NAT64_RECS}")
endif(CPC_OTBR_NAT64)

if(CPC_OTBR_DNS64)
    string(APPEND CPC_OTBR_RECS ", ${DNS64_RECS}")
endif(CPC_OTBR_DNS64)

if(CPC_OTBR_NETWORK_MANAGER)
    string(APPEND CPC_OTBR_RECS ", ${NETWORK_MANAGER_RECS}")
endif(CPC_OTBR_NETWORK_MANAGER)

if(CPC_OTBR_DHCPV6_PD)
    string(APPEND CPC_OTBR_RECS ", ${DHCPV6_PD_RECS}")
endif(CPC_OTBR_DHCPV6_PD)

if(CPC_OTBR_REFERENCE_DEVICE)
    string(APPEND CPC_OTBR_RECS ", ${REFERENCE_DEVICE_RECS}")
...
endif(CPC_OTBR_REFERENCE_DEVICE)

if(CPC_OTBR_BACKBONE_ROUTER)
    string(APPEND CPC_OTBR_RECS ", ${BACKBONE_ROUTER_RECS}")
...
endif(CPC_OTBR_BACKBONE_ROUTER)

if(CPC_OTBR_BORDER_ROUTING)
    set(OTBR_BORDER_ROUTING ON CACHE BOOL "enable border routing features")
endif(CPC_OTBR_BORDER_ROUTING)

# if(CPC_OTBR_WEB_GUI)
#     string(APPEND CPC_OTBR_RECS ", ${WEB_GUI_RECS}")
#     set(OTBR_WEB ON CACHE BOOL "enable web gui service")
# endif(CPC_OTBR_WEB_GUI)

# if(CPC_OTBR_REST_API)
...
set(CPACK_DEBIAN_UIC-OTBR_PACKAGE_RECOMMENDS ${CPC_OTBR_RECS} CACHE STRING "Package recommendations for cpc-otbr: ${CPC_OTBR_RECS}" FORCE)
