...
class FeatureFlagList PROTOBUF_FINAL :
 ...
 public:
  ...
  inline FeatureFlagList* New() const final {
    return CreateMaybeMessage<FeatureFlagList>(nullptr);
  }

  FeatureFlagList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void FeatureFlagList::_internal_set_enable_detailed_logging(bool value) {
  _has_bits_[0] |= 0x00000002u;
  enable_detailed_logging_ = value;
}
...
inline ::otbr::ProtoLogLevel FeatureFlagList::_internal_detailed_logging_level() const {
  return static_cast< ::otbr::ProtoLogLevel >(detailed_logging_level_);
}
...
inline void FeatureFlagList::_internal_set_enable_dns_upstream_query(bool value) {
  _has_bits_[0] |= 0x00000008u;
  enable_dns_upstream_query_ = value;
}
