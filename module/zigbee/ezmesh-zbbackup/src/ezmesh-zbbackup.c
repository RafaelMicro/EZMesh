...
static void a_write(void *p_data)
{
    ...
    if (fp)
    {
        ...
        libezmesh_write_ep(endpoint, &fw_wr_cmd[0], 0x10D, 0);
...
static void a_read_mac_addr(void *p_data)
{
    ...
    libezmesh_write_ep(endpoint, &fw_read_mac_cmd[0], sizeof(fw_read_mac_cmd), 0);        
}
...
static void a_write_start(void *p_data)
{
    ...
    libezmesh_write_ep(endpoint, &fw_wr_start_cmd[0], sizeof(fw_wr_start_cmd), 0);    
}
...
static void a_page_read(void *p_data)
{
    ...
    if (fp)
    {
        ...
        libezmesh_write_ep(endpoint, &page_read_cmd[0], sizeof(page_read_cmd), 0);
